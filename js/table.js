...
function get_number(id, number) {
  ...
  $(document).on('click', '#add', function(){
    ...
    if (table_name=="ncatalog"){
      ...
      html += '<td><button type="button" name="insert" id="insert" class="btn btn-success btn-xs">Вставить</button></td>';
      html += '</tr>';
      ...
      html += '<td id="data1"></td>';
      html += '<td contenteditable id="data2"></td>';
      html += '<td><button type="button" name="insert" id="insert_table" class="btn btn-success btn-xs" data-table="'+table_name+'">Вставить</button></td>';
      html += '</tr>';
      $('#user_data tbody').prepend(html);}
    });

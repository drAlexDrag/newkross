...
/////////////////////ЛОГ ДАННЫХ КРОСА////////////////////
  ...
  R::store($logkross);
/////////////////////////////////////////////////////////
  // if ($ncatalog_id_old!=$updateKrossData["ncatalog"]){
  // var_dump($ncatalog_id);
  //   R::exec( 'UPDATE krossdata SET ncatalog_id=:new_value WHERE ncatalog_id=:old_value', [
  //     'new_value'=>$updateKrossData["ncatalog"],
  //     'old_value'=>$ncatalog_id_old
  //   ]);
  // }
